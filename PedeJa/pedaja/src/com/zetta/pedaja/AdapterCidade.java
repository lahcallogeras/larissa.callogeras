...
public class AdapterCidade extends BaseAdapter implements SpinnerAdapter {

	Context context; 
	
    private final ArrayList<ModelCidade> data;
    public AdapterCidade(ArrayList<ModelCidade> data, Context context){
        this.data = data;
