...
public class ContaGarcomFragment extends Fragment  {
	Context context ;
	private Handler handler;
    private String msgErro;
	private ProgressDialog progressDialog;
	ListView  lstViewContaGarcom;
	TextView txtTotalConta;
	ArrayList<ModelVisualizarPedido> lista;
	Button btnContaTotalDividir;
	double total;
	
	public ContaGarcomFragment(Context context){
	  ...
	  public View onCreateView(LayoutInflater inflater, ViewGroup container,  Bundle savedInstanceState) {		 
	        ...
	        View rootView = inflater.inflate(R.layout.conta_garcom, container, false);
	        lstViewContaGarcom = (ListView)  rootView.findViewById(R.id.lstContaGarcom);
	  ...
	  @SuppressLint({ "HandlerLeak", "SimpleDateFormat" })
		private void atualizarItensContaGarcom(){			
				Progresso("Aguarde");
			      	            	...
			      	            	lista = new ArrayList<ModelVisualizarPedido>();
			       	        		...
			       	        		if(conexao){	       	        			
			       	        			...
			       	        			String httpGet = Global.urlConexaoLocal + "visualizarConta.php";
				       	     			...
				       	     			params.add(new BasicNameValuePair("P3", "0"));
			    ...
			    handler=new Handler(){
			  		 public void handleMessage(Message msg){
			  			try{
					        ...
					        lstViewContaGarcom.setAdapter((ListAdapter) adapter);       
